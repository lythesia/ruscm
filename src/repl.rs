...
use rustyline::{
    ...
    Cmd, Context, Editor, Helper, KeyPress,
};

use crate::completer::ReplCompleter;
use crate::internals::List;
use crate::interpreter::{process, prologue, Env};
...
impl Hinter for ReplHelper {
    fn hint(&self, line: &str, pos: usize, ctx: &Context<'_>) -> Option<String> {
        ...
        None // disable history for now, since it's noisy
    }
}
...
impl Repl {
        ...
        F: Fn(&Token) -> bool,
    {
        tokens
            .iter()
            .fold(0, |acc, (i, _)| if f(i) { acc + 1 } else { acc })
    }
    ...
    pub fn run(&mut self) {
        ...
        loop {
            ...
            let next = match curr {
                ...
                State::Parse(tokens) => match Parser::parse(&tokens) {
